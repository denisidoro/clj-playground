(defproject playground "0.1.0-SNAPSHOT"
  ...
  :description "A playground for Clojure quick projects"

  :url "https://github.com/denisidoro/clj-playground"
  ...
  :profiles {:dev     {:aliases        {"run-dev" ["trampoline" "run" "-m" "playground.core/foo"]}
  ...
  :aliases {"unit" ["trampoline" "run" "-m" "playground.runner/main"]
            "integration" ["trampoline" "run" "-m" "integration.runner/main"]}
  ...
  :main ^{:skip-aot true} playground.core)
